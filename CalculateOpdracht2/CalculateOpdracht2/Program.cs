...
namespace CalculateOpdracht2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double totaalControllerPrijs = 139.99;// controllersInMandje keer controllerPrijs
            double totaalGamePrijs = 119.99;// game1 keer gamePrijs  + game2 keer gamePrijs (let op je haakjes!)
